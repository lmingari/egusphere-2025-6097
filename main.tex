...
\codeavailability{
  ...
  %
  The code and data used for the synthetic and Etna experiments
  are available in the supplementary material repositories
  \citep{mingari2026supplementary-synthetic,
  mingari2026supplementary-etna}.
}
